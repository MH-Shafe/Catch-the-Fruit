...
void write_score()
{
        ...
        write_function(.85,.9,0,GLUT_BITMAP_HELVETICA_18,text);
...
fruitBasket();
    ...
    write_function(.85,.95,0,GLUT_BITMAP_HELVETICA_18,"level 1");
    write_score();
    ground();
    drawGrass();
    riverbank ();
...
fruitBasket();
    ...
    score_board();
    glColor3f(1.0f, 1.0f,1.0f);
    write_function(.85,.95,0,GLUT_BITMAP_HELVETICA_18,"level 2");
    write_score();
    ground();
    drawGrass();
    riverbank ();
...
fruitBasket();
    ...
    score_board();
    glColor3f(1.0f, 1.0f,1.0f);
    write_function(.85,.95,0,GLUT_BITMAP_HELVETICA_18,"level 3");
    write_score();
    ground();
    drawGrass();
    riverbank ();
